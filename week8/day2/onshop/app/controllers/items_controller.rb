...
class ItemsController < ApplicationController
  ...
  def add_to_cart
    ...
    #   AdminMailer.add_to_cart(admin, current_user, session).deliver_now
    # end
    redirect_to :back
  end
  ...
  def checkout
    ...
    purchase_confirmation_email = PurchaseMailer.confirmation(current_user, cart)
    purchase_confirmation_email.deliver_now
